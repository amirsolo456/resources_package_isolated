...
class ThemeColorsManager {
  ...
  Color get themCounterColor =>
      isDark ? dark.FontColors.counterTheme : light.FontColors.counterTheme;

  Color get themNotCounterColor => isDark
      ? dark.FontColors.notCounterTheme
      : light.FontColors.notCounterTheme;
}
